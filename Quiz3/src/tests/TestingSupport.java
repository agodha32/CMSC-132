...
public class TestingSupport {
	...
	/*
	 * Students: Do not use this method. This method can cause tests to fail. We use
	 * it with special submit server settings. We leave it here in case you want to
	 * use it to check your code for a particular construct.
	 */
	public static boolean hasLoopConstruct(String fileName) {
		...
		try {
			...
			while (fileScanner.hasNextLine()) {
				...
				if ((line.indexOf("for") != -1) || (line.indexOf("do") != -1) || (line.indexOf("while") != -1)) {
					throw new IllegalArgumentException("Source Code Using Iteration Statement");
				}
